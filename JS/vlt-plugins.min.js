    ...
    var e = "animsition"
      , i = {
        init: function(n) {
            ...
            return s || !(n.browser.length > 0) || s && this.length ? (i.optionCheck.call(this, n) && t("." + n.overlayClass).length <= 0 && i.addOverlay.call(this, n),
            ...
            this.each(function() {
                ...
                n.onLoadEvent && r.on("load." + e, function() {
        ...
        animationCheck: function(i, n, s) {
            ...
            return l || c ? i = i : n && s ? i = r.inClass : !n && s ? i = r.inDuration : n && !s ? i = r.outClass : n || s || (i = r.outDuration),
            i
        },
        in: function() {
            var n = this
...
function(t, e) {
    ...
    function o(t, e, i) {
        ...
        if (l >= 0 && c > 0) {
            ...
            a = i.length; d >= 0 && !o; )
                d == l ? (n.push(d),
                l = i.indexOf(t, d + 1)) : 1 == n.length ? o = [n.pop(), c] : ((s = n.pop()) < a && (a = s,
                r = c),
                c = i.indexOf(e, d + 1)),
                d = l < c && l >= 0 ? l : c;
            n.length && (o = [a, r])
    ...
    function l(e) {
        ...
        function f() {
            ...
            var a = c() || []
              , r = v.preserveStatic ? u() : u().filter(function(t) {
        ...
        if (S) {
            ...
            if ("loading" !== document.readyState)
                if (T && o.onlyLegacy) {
                    ...
                    !A && (o.shadowDOM || o.rootElement.shadowRoot || o.rootElement.host) ? n({
                    ...
                    n({
                        ...
                        onComplete: function(n, a) {
                            ...
                            t(h, o.variables),
                            v = Boolean((document.querySelector("[data-cssvars]") || Object.keys(M.dom).length) && Object.keys(h).some(function(t) {
                                return h[t] !== p[t]
                            })),
                            t(p, M.user, h),
                            v)
                                            ...
                                            if (o.updateDOM) {
                                                ...
                                                a.length) {
                                                    ...
                                                    c.parentNode.removeChild(c))) : l !== c.textContent.replace(/\s/g, "") && ([e, c].forEach(function(t) {
                                                        t.setAttribute("data-cssvars-job", C.job),
                                                ...
                                                e.textContent.replace(/\s/g, "") !== a && y.push(a)
                                        } catch (t) {
                                            i(t.message, e)
                                        }
                                    n && e.setAttribute("data-cssvars", "skip"),
                                    e.hasAttribute("data-cssvars-job") || e.setAttribute("data-cssvars-job", C.job)
                                }),
                                ...
                                k = !1,
                                o.onComplete(y.join(""), w, JSON.parse(JSON.stringify(p)), g() - o.__benchmark)
                            }
                        }
                    }));
            else
...
function() {
    ...
    t.prototype.onTouchEnd = function(t) {
        ...
        "label" === (o = d.tagName.toLowerCase())) {
            ...
            t.preventDefault()),
            !1);
        return !(!n || s || !(l = d.fastClickScrollParent) || l.fastClickLastScrollTop === l.scrollTop) || (this.needsClick(d) || (t.preventDefault(),
        this.sendClick(d, t)),
        !1)
    }
    ,
...
function(t, e) {
    ...
    function v(t) {
        ...
        for (i = t.length; i--; )
            t[i] && (t[i]._gsap || (t[i]._gsap = new vi(t[i],e))) || t.splice(i, 1);
        return t
    }
    function g(t) {
    ...
    function B(t, e) {
        var i;
        if ((e._time || e._initted && !e._dur) && (i = D(t.rawTime(), e),
    ...
    function j(t, e, i, n) {
        return xi(t, e),
        t._initted ? !i && t._pt && (t._dur && !1 !== t.vars.lazy || !t._dur && t.vars.lazy) && re !== li.frame ? (Ne.push(t),
        t._lazy = [e, n],
        1) : void 0 : 1
    }
    function H(t, e, i) {
    ...
    function N(t, e) {
        ...
        1 < i ? N(t, e.substr(0, i - 1)) + s : o + s) : null == e ? o : +e
    }
    function q(t, e) {
        return t || 0 === t ? e(t) : e
    }
    ...
    function at(t, e, i) {
        ...
        (n = i.c).join(o) !== a.c.join(o)))
            for (r = (s = t.replace(ri, "1").split(De)).length - 1; d < r; d++)
                o += s[d] + (~n.indexOf(d) ? l.shift() || c + "0,0,0,0)" : (a.length ? a : l.length ? l : i).shift());
        if (!s)
            for (r = (s = t.split(ri)).length - 1; d < r; d++)
                o += s[d] + l[d];
        return o + s[r]
    }
    function rt(t) {
    ...
    function mt(t, e, i, a, r, l) {
        ...
        if (Ye[t] && !1 !== (c = new Ye[t]).init(r, c.rawVars ? e[t] : function(t, e, i, a, r) {
            ...
            !o(t) || t.style && t.nodeType || ze(t))
                return n(t) ? Si(t, r, e, i, a) : t;
            var l, c = {};
            for (l in t)
                c[l] = Si(t[l], r, e, i, a);
            return c
        }(e[t], a, r, l, i), i, a, l) && (i._pt = d = new Fi(i._pt,r,t,0,1,c.render,c,0,c.priority),
        i !== oe))
            ...
            init: function(t, i, s) {
                s._onInit = function(t) {
                    ...
                    !function(t, e) {
                        ...
                        for (i in e)
                            for (n = a.length; n--; )
                                (s = (s = t._ptLookup[n][i]) && s.d) && (s._pt && (s = yt(s, i)),
    ...
    function Dt(t) {
        var e, i = zt("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), n = this.parentNode, s = this.nextSibling, a = this.style.cssText;
        if (Vi.appendChild(i),
        i.appendChild(this),
    ...
    function Bt(t) {
        ...
        return e && (e.width || e.height) || t.getBBox === Dt || (e = Dt.call(t, !0)),
        !e || e.width || e.x || e.y ? e : {
            x: +Ft(t, ["x", "cx", "x1"]) || 0,
            y: +Ft(t, ["y", "cy", "y1"]) || 0,
            width: 0,
    ...
    function jt(t, e) {
        if (e) {
            ...
            i.removeProperty(e.replace(gn, "-$1").toLowerCase())) : i.removeAttribute(e)
        }
    }
    ...
    function Vt(t, e, i, n) {
        var s, a, r, o, l = parseFloat(i) || 0, c = (i + "").trim().substr((l + "").length) || "px", d = qi.style, u = bn.test(e), h = "svg" === t.tagName.toLowerCase(), p = (h ? "client" : "offset") + (u ? "Width" : "Height"), f = "px" === n;
        return n === c || !l || En[n] || En[c] ? l : (o = t.getCTM && Rt(t),
        "%" === n && (pn[e] || ~e.indexOf("adius")) ? w(l / (o ? t.getBBox()[u ? "width" : "height"] : t[p]) * 100) : (d[u ? "width" : "height"] = 100 + (f ? c : n),
        a = ~e.indexOf("adius") || "em" === n && t.appendChild && !h ? t : t.parentNode,
        o && (a = (t.ownerSVGElement || {}).parentNode),
        a && a !== Hi && a.appendChild || (a = Hi.body),
        (r = a._gsap) && "%" === n && r.width && u && r.time === li.time ? w(l / r.width * 100) : (a === t && (d.position = "static"),
        a.appendChild(qi),
        s = qi[p],
        a.removeChild(qi),
        d.position = "absolute",
        u && "%" === n && ((r = g(a)).time = li.time,
        r.width = a[p]),
        w(f ? s * l / 100 : 100 / s * l))))
    }
    function Nt(t, e, i, n) {
        ...
        pn[e] && "transform" !== e ? (s = $n(t, n),
        s = "transformOrigin" !== e ? s[e] : Ln(Ot(t, Sn)) + " " + s.zOrigin + "px") : (s = t.style[e]) && "auto" !== s && !n && !~(s + "").indexOf("calc(") || (s = Mn[e] && Mn[e](t, e, i) || Ot(t, e) || b(t, e) || ("opacity" === e ? 1 : 0)),
    ...
    function qt(t, e, i, n) {
        ...
        (n.match(De) || []).length) {
            ...
            b.r = "display" === e && "none" === n ? _t : Et;
        return Re.test(n) && (b.e = 0),
        this._pt = b
    }
    function Yt(t) {
        var e = t.split(" ")
    ...
    function Ut(t, e) {
        ...
        return r.svg && t.getAttribute("transform") ? "1,0,0,1,0,0" === (l = [(s = t.transform.baseVal.consolidate().matrix).a, s.b, s.c, s.d, s.e, s.f]).join(",") ? kn : l : (l !== kn || t.offsetParent || t === Vi || r.svg || (s = o.display,
        o.display = "block",
    ...
    function Qt(t, e, i, n, s, a) {
        var r, o, l, c = t._gsap, d = s || Ut(t, !0), u = c.xOrigin || 0, h = c.yOrigin || 0, p = c.xOffset || 0, f = c.yOffset || 0, m = d[0], v = d[1], g = d[2], b = d[3], y = d[4], w = d[5], x = e.split(" "), S = parseFloat(x[0]) || 0, T = parseFloat(x[1]) || 0;
        i ? d !== kn && (o = m * b - v * g) && (l = S * (-v / o) + T * (m / o) - (m * w - v * y) / o,
        S = S * (b / o) + T * (-g / o) + (g * w - b * y) / o,
        T = l) : (S = (r = Bt(t)).x + (~x[0].indexOf("%") ? S / 100 * r.width : S),
        T = r.y + (~(x[1] || x[0]).indexOf("%") ? T / 100 * r.height : T)),
        n || !1 !== n && c.smooth ? (y = S - u,
        w = T - h,
        c.xOffset = p + (y * m + w * g) - y,
        c.yOffset = f + (y * v + w * b) - w) : c.xOffset = c.yOffset = 0,
        c.xOrigin = S,
        c.yOrigin = T,
        c.smooth = !!n,
        c.origin = e,
    ...
    function Kt(t, e, i, s, a, r) {
        var o, l, c = 360, d = n(a), u = parseFloat(a) * (d && ~a.indexOf("rad") ? fn : 1), h = r ? u * r : u - s, p = s + h + "deg";
        return d && ("short" === (o = a.split("_")[1]) && (h %= c) != h % 180 && (h += h < 0 ? c : -c),
        "cw" === o && h < 0 ? h = (h + 36e9) % c - ~~(h / c) * c : "ccw" === o && 0 < h && (h = (h - 36e9) % c - ~~(h / c) * c)),
    ...
    function Zt(t, e, i) {
        ...
        n = $n(Yi, 1),
        pn)
            (a = u[s]) !== (r = n[s]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(s) < 0 && (o = Y(a) !== (c = Y(r)) ? Vt(i, s, a, c) : parseFloat(a),
            l = parseFloat(r),
    ...
    var te, ee, ie, ne, se, ae, re, oe, le, ce, de, ue, he, pe, fe, me, ve, ge, be, ye, we, xe, Se, Te = {
        autoSleep: 120,
        force3D: "auto",
        nullTargetWarn: 1,
        units: {
        ...
        overwrite: !1,
        delay: 0
    }, Ee = 1e8, _e = 1 / Ee, Me = 2 * Math.PI, ke = Me / 4, Pe = 0, $e = Math.sqrt, Le = Math.cos, Ae = Math.sin, ze = Array.isArray, Oe = /(?:-?\.?\d|\.)+/gi, Ie = /[-+=.]*\d+[.e\-+]*\d*[e\-\+]*\d*/g, De = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Fe = /[-+=.]*\d+(?:\.|e-|e)*\d*/gi, Be = /\(([^()]+)\)/i, Re = /[+-]=-?[\.\d]+/, je = /[#\-+.]*\b[a-z\d-=+%.]+/gi, He = {}, Ve = {}, Ne = [], qe = {}, Ye = {}, Xe = {}, We = 30, Ge = [], Ue = "", Qe = function(t, e) {
        for (var i in e)
            t[i] = e[i];
        return t
    }, Je = function(t, e) {
    ...
    mi.startTime = function(t) {
        return arguments.length ? (this.parent && this.parent._sort && R(this.parent, this, t - this._delay),
        this) : this._start
    }
    ,
    ...
    var bi = function(t) {
        ...
        return o.to = function(t, e, i, n) {
            return new Ei(t,S(arguments, 0, this),N(this, a(e) ? n : i)),
            this
        }
        ,
        o.from = function(t, e, i, n) {
            return new Ei(t,S(arguments, 1, this),N(this, a(e) ? n : i)),
            this
        }
        ,
        o.fromTo = function(t, e, i, n, s) {
            return new Ei(t,S(arguments, 2, this),N(this, a(e) ? s : n)),
            this
        }
        ,
        ...
        o.render = function(t, e, i) {
            var n, s, a, r, o, l, c, d, u, h, p, f, m = this._time, v = this._dirty ? this.totalDuration() : this._tDur, g = this._dur, b = this !== te && v - _e < t && 0 <= t ? v : t < _e ? 0 : t, y = this._zTime < 0 != t < 0 && (this._initted || !g);
            if (b !== this._tTime || i || y) {
                if (m !== this._time && g && (b += this._time - m,
                t += this._time - m),
                n = b,
                u = this._start,
                l = !(d = this._ts),
                ...
                (b === v && v >= this.totalDuration() || !b && this._ts < 0) && (u !== this._start && Math.abs(d) === Math.abs(this._ts) || (!t && g || !(t && 0 < this._ts || !b && this._ts < 0) || z(this, 1),
                e || t < 0 && !m || (ni(this, b === v ? "onComplete" : "onReverseComplete", !0),
        ...
        o.getChildren = function(t, e, i, n) {
            ...
            for (var s = [], a = this._first; a; )
                a._start >= n && (a instanceof Ei ? e && s.push(a) : (i && s.push(a),
        ...
        ,
        o.remove = function(t) {
            return n(t) ? this.removeLabel(t) : s(t) ? this.killTweensOf(t) : (A(this, t),
        ...
        o.getTweensOf = function(t, e) {
            for (var i, n = [], s = ei(t), a = this._first; a; )
                a instanceof Ei ? !x(a._targets, s) || e && !a.isActive("started" === e) || n.push(a) : (i = a.getTweensOf(s, e)).length && n.push.apply(n, i),
                a = a._next;
            return n
        }
        ,
        ...
        o.totalDuration = function(t) {
            ...
            if (r._dirty) {
                for (s = r.parent; o; )
                    ...
                    R(r, o, n - o._delay, 1)._lock = 0) : l = n,
                    n < 0 && o._ts && (a -= n,
                    ...
                    a < (i = F(o)) && o._ts && (a = i),
                    o = e;
                H(r, r === te && r._time > a ? r._time : Math.min(Ee, a), 1),
                r._dirty = 0
            }
            return r._tDur
        }
    ...
    var yi, wi = function(t, e, i, a, r, o, l, c, d) {
        s(a) && (a = a(r || 0, t, o));
        var u, p = t[e], f = "get" !== i ? i : s(p) ? d ? t[e.indexOf("set") || !s(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](d) : t[e]() : p, m = s(p) ? d ? ki : Mi : _i;
        if (n(a) && (~a.indexOf("random(") && (a = Z(a)),
        "=" === a.charAt(1) && (a = parseFloat(f) + parseFloat(a.substr(2)) * ("-" === a.charAt(0) ? -1 : 1) + (Y(f) || 0))),
        f !== a)
            return isNaN(f + a) ? (p || e in t || h(e, a),
            ...
            .call(this, t, e, f, a, m, c || Te.stringFilter, d)) : (u = new Fi(this._pt,t,e,+f || 0,a - (f || 0),"boolean" == typeof p ? Li : $i,0,m),
            d && (u.fp = d),
        ...
        !j) {
            ...
            S = O && l(S) || S && !O,
            s = 0; s < D.length; s++) {
                if (d = (o = D[s])._gsap || v(D)[s]._gsap,
                e._ptLookup[s] = p = {},
                qe[d.id] && T(),
                f = B === D ? s : B.indexOf(o),
                u && !1 !== (h = new u).init(o, m || n, e, f, B) && (e._pt = r = new Fi(e._pt,o,h.name,0,1,h.render,h,0,h.priority),
                ...
                !u || m)
                    for (a in n)
                        Ye[a] && (h = mt(a, n, e, f, o, B)) ? h.priority && (c = 1) : p[a] = r = wi.call(e, o, a, "get", n[a], f, B, 0, b.stringFilter);
    ...
    }, Ti = Ue + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", Ci = (Ti + ",id,stagger,delay,duration,paused").split(","), Ei = function(t) {
        function s(e, n, s, r) {
            var c;
            "number" == typeof n && (s.duration = n,
            n = s,
            s = null);
            var u, h, f, g, b, y, w, x, S = (c = t.call(this, r ? n : L(n), s) || this).vars, T = S.duration, C = S.delay, E = S.immediateRender, _ = S.stagger, k = S.overwrite, P = S.keyframes, $ = S.defaults, A = c.parent, z = (ze(e) ? a(e[0]) : "length"in n) ? [e] : ei(e);
            if (c._targets = z.length ? v(z) : p("GSAP target " + e + " not found. https://greensock.com", !Te.nullTargetWarn) || [],
            c._ptLookup = [],
            c._overwrite = k,
            P || _ || d(T) || d(C)) {
                if (n = c.vars,
                ...
                P)
                    ...
                    o(_))
                        for (b in _)
                            ~Ti.indexOf(b) && ((x = x || {})[b] = _[b]);
                    for (h = 0; h < g; h++) {
                        for (b in f = {},
                        n)
                            Ci.indexOf(b) < 0 && (f[b] = n[b]);
                        f.stagger = 0,
                        x && Qe(f, x),
                        ...
                        !_ && 1 === g && f.delay && (c._delay = C = f.delay,
                        c._start += C,
                        f.delay = 0),
                        u.to(y, f, w(h, y, z))
                    }
            ...
            yi = 0),
            A && B(A, i(c)),
            (E || !T && !P && c._start === A._time && l(E) && function t(e) {
                return !e || e._ts && t(e.parent)
            }(i(c)) && "nested" !== A.data) && (c._tTime = -_e,
            c.render(Math.max(0, -C))),
            c
        }
        e(s, t);
        var r = s.prototype;
        return r.render = function(t, e, i) {
            var n, s, a, r, o, l, c, d, u, h = this._time, p = this._tDur, f = this._dur, m = p - _e < t && 0 <= t ? p : t < _e ? 0 : t;
            if (f) {
                if (m !== this._tTime || !t || i || this._startAt && this._zTime < 0 != t < 0) {
                    ...
                    e || t < 0 && !h || m < p && 0 < this.timeScale() || (ni(this, m === p ? "onComplete" : "onReverseComplete", !0),
                    this._prom && this._prom()))
                }
            } else
                !function(t, e, i, n) {
                    var s, a = t._zTime < 0 ? 0 : 1, r = e < 0 ? 0 : 1, o = t._rDelay, l = 0;
                    if (o && t._repeat && (l = Ze(0, t._tDur, e),
                    Je(l, o) !== Je(t._tTime, o) && (a = 1 - r,
                    ...
                    (t._initted || !j(t, e, n, i)) && (r !== a || n || t._zTime === _e || !e && t._zTime)) {
                        ...
                        (e >= t._tDur || e < 0) && t.ratio === r && (t.ratio && z(t, 1),
        ...
        r.kill = function(t, e) {
            ...
            this.parent))
                return et(this);
            if (this.timeline)
                return this.timeline.killTweensOf(t, e, yi && !0 !== yi.vars.overwrite),
                this;
            ...
            c = d.length); c--; )
                if (~u.indexOf(d[c]))
                    ...
                    r = e),
                    r)
                        (l = s && s[o]) && ("kill"in l.d && !0 !== l.d.kill(o) || A(this, l, "_pt"),
                        delete s[o]),
                        "all" !== a && (a[o] = 1);
    ...
    var _i = function(t, e, i) {
      ...
      , Ii = function(t) {
        for (var e, i, n = this._pt; n; )
            i = n._next,
            n.p === t && !n.op || n.op === t ? A(this, n, "_pt") : n.dep || (e = 1),
            n = i;
        return !e
    }
      , Di = function(t) {
    ...
    var Bi = {
        ...
        defaults: function(t) {
            return t && t.ease && (t.ease = fi(t.ease, Ce.ease)),
            P(Ce, t || {})
        },
        config: function(t) {
            return P(Te, t || {})
        ...
        exportRoot: function(t, e) {
            ...
            i = te._first; i; )
                n = i._next,
                !e && !i._dur && i instanceof Ei && i.vars.onComplete === i._targets[0] || R(s, i, i._start - i._delay),
                i = n;
            return R(te, s, 0),
            s
        },
    ...
    Ei.version = bi.version = Ri.version = "3.2.4",
    ae = 1,
    c() && ci();
    var ji, Hi, Vi, Ni, qi, Yi, Xi, Wi, Gi = di.Power0, Ui = di.Power1, Qi = di.Power2, Ji = di.Power3, Ki = di.Power4, Zi = di.Linear, tn = di.Quad, en = di.Cubic, nn = di.Quart, sn = di.Quint, an = di.Strong, rn = di.Elastic, on = di.Back, ln = di.SteppedEase, cn = di.Bounce, dn = di.Sine, un = di.Expo, hn = di.Circ, pn = {}, fn = 180 / Math.PI, mn = Math.PI / 180, vn = Math.atan2, gn = /([A-Z])/g, bn = /(?:left|right|width|margin|padding|x)/i, yn = /[\s,\(]\S/, wn = {
        autoAlpha: "opacity,visibility",
        scale: "scaleX,scaleY",
        alpha: "opacity"
    }, xn = "transform", Sn = xn + "Origin", Tn = "O,Moz,ms,Ms,Webkit".split(","), Cn = function(t, e, i) {
        var n = (e || qi).style
          , s = 5;
        if (t in n && !i)
            return t;
        ...
        if ("x"in i && !e && !i.uncache)
            return i;
        var n, s, a, r, o, l, c, d, u, h, p, f, m, v, g, b, y, x, S, T, C, E, _, M, k, P, $, L, A, z, O, I, D = t.style, F = i.scaleX < 0, B = "deg", R = Ot(t, Sn) || "0";
        return n = s = a = l = c = d = u = h = p = 0,
        r = o = 1,
        i.svg = !(!t.getCTM || !Rt(t)),
        v = Ut(t, i.svg),
        i.svg && (M = !i.uncache && t.getAttribute("data-svg-origin"),
        ...
        n = E = v[4],
        s = _ = v[5],
        6 === v.length ? (r = Math.sqrt(x * x + S * S),
        o = Math.sqrt(C * C + T * T),
        l = x || S ? vn(S, x) * fn : 0,
        ...
        a = v[14],
        c = (g = vn(I, A)) * fn,
        g && (M = E * (b = Math.cos(-g)) + $ * (y = Math.sin(-g)),
        k = _ * b + L * y,
        P = I * b + A * y,
        $ = E * -y + $ * b,
        L = _ * -y + L * b,
        ...
        T = P = T * b - A * y),
        l = (g = vn(S, x)) * fn,
        g && (M = x * (b = Math.cos(g)) + S * (y = Math.sin(g)),
        k = E * b + _ * y,
        S = S * b - x * y,
        _ = _ * b - E * y,
        x = M,
        ...
        90 < Math.abs(u) && Math.abs(u) < 270 && (F ? (r *= -1,
        u += l <= 0 ? 180 : -180,
        l += l <= 0 ? 180 : -180) : (o *= -1,
        u += u <= 0 ? 180 : -180)),
        ...
        var i, n, s, a, r, o = e || this, l = o.xPercent, c = o.yPercent, d = o.x, u = o.y, h = o.rotation, p = o.skewX, f = o.skewY, m = o.scaleX, v = o.scaleY, g = o.target, b = o.xOrigin, y = o.yOrigin, x = o.xOffset, S = o.yOffset, T = o.forceCSS, C = parseFloat(d), E = parseFloat(u);
        h = parseFloat(h),
        p = parseFloat(p),
        ...
        a = v,
        n = s = 0),
        (C && !~(d + "").indexOf("px") || E && !~(u + "").indexOf("px")) && (C = Vt(g, "x", d, "px"),
        E = Vt(g, "y", u, "px")),
        (b || y || x || S) && (C = w(C + b - (b * i + y * s) + x),
        E = w(E + y - (b * n + y * a) + S)),
        (l || c) && (r = g.getBBox(),
        C = w(C + l / 100 * r.width),
            ...
            e)
                ...
                !Ye[u] || !mt(u, e, i, n, t, s)))
                    ...
                    d)
                        ...
                        o = parseFloat(r),
                        u in wn && ("autoAlpha" === u && (1 === l && "hidden" === Nt(t, "visibility") && o && (l = 0),
                        Ht(this, S, "visibility", l ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)),
                        "scale" !== u && "transform" !== u && ~(u = wn[u]).indexOf(",") && (u = u.split(",")[0])),
                        v = u in pn)
                            if (g || ((b = t._gsap).renderTransform || $n(t),
                            y = !1 !== e.smoothOrigin && b.smooth,
                            (g = this._pt = new Fi(this._pt,S,xn,0,1,b.renderTransform,b,0,-1)).dep = 1),
                            "scale" === u)
                                ...
                                if ("transformOrigin" === u) {
                                    r = Yt(r),
                                    b.svg ? Qt(t, r, 0, y, 0, this) : ((f = parseFloat(r.split(" ")[2]) || 0) !== b.zOrigin && Ht(this, b, "zOrigin", b.zOrigin, f),
...
, function(t, e, i) {
    ...
    function o() {
        u = g ? (!d && document.body && ((d = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;",
        document.body.appendChild(d)),
        (d ? d.clientHeight : 0) || f.window.innerHeight || document.documentElement.clientHeight) : f.window.innerHeight || document.documentElement.clientHeight
    }
    function l() {
    ...
    i.r(e);
    var d, u, h = i(2), p = i.n(h), f = i(3), m = f.window.navigator, v = -1 < m.userAgent.indexOf("MSIE ") || -1 < m.userAgent.indexOf("Trident/") || -1 < m.userAgent.indexOf("Edge/"), g = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(m.userAgent), b = function() {
    ...
    var y = []
      ...
      , x = function() {
        ...
        (i = [{
            key: "css",
            value: function(t, e) {
                return "string" == typeof e ? f.window.getComputedStyle(t).getPropertyValue(e) : (e.transform && b && (e[b] = e.transform),
            ...
            value: function() {
                ...
                1 === y.length && f.window.requestAnimationFrame(l)
            }
        }, {
            ...
            key: "onScroll",
            value: function(t) {
                var e, i, n, s, a, r, o, l, c, d, h = this, p = h.$item.getBoundingClientRect(), m = p.top, v = p.height, g = {}, b = p;
                ...
                (t || h.isElementInViewport) && (e = Math.max(0, m),
                i = Math.max(0, v + m),
                n = Math.max(0, -m),
                s = Math.max(0, m + v - u),
                ...
                "opacity" !== h.options.type && "scale-opacity" !== h.options.type && "scroll-opacity" !== h.options.type || (g.transform = "translate3d(0,0,0)",
                g.opacity = l),
                "scale" !== h.options.type && "scale-opacity" !== h.options.type || (c = 1,
                h.options.speed < 0 ? c -= h.options.speed * l : c += h.options.speed * (1 - l),
                g.transform = "scale(".concat(c, ") translate3d(0,0,0)")),
                "scroll" !== h.options.type && "scroll-opacity" !== h.options.type || (d = h.parallaxScrollDistance * o,
                "absolute" === h.image.position && (d -= m),
                g.transform = "translate3d(0,".concat(d, "px,0)")),
                h.css(h.image.$item, g),
                h.options.onScroll && h.options.onScroll.call(h, {
                    section: p,
                    beforeTop: e,
                    beforeTopEnd: i,
                    afterTop: n,
    ...
    i) {
        ...
        i.extend(v.prototype, {
            ...
            addContent: function(t) {
                ...
                i.each(s, function(t, e) {
                    ...
                    d = e.opts || e) : "object" === i.type(e) && i(e).length ? (s = i(e),
                    d = s.data() || {},
            ...
            jumpTo: function(t, e) {
                ...
                if (!(h.isDragging || h.isClosing || h.isAnimating && h.firstRun)) {
                    ...
                    h.prevPos = h.currPos,
                    r = h.createSlide(t),
                    f > 1 && ((a || r.index < f - 1) && h.createSlide(t + 1),
                    ...
                    i.fancybox.animate(o.$slide, d, e, function() {
            ...
            scaleToActual: function(t, e, n) {
                var s, a, r, o, l, c = this, d = c.current, u = d.$content, h = i.fancybox.getTranslate(d.$slide).width, p = i.fancybox.getTranslate(d.$slide).height, f = d.width, m = d.height;
            ...
            getFitPos: function(t) {
                var e, n, s, a, r = this, o = t.$content, l = t.$slide, c = t.width || t.opts.width, d = t.height || t.opts.height, u = {};
                ...
                c > e - .5 && (c = e),
                d > n - .5 && (d = n),
                "image" === t.type ? (u.top = Math.floor(.5 * (n - d)) + parseFloat(l.css("paddingTop")),
                u.left = Math.floor(.5 * (e - c)) + parseFloat(l.css("paddingLeft"))) : "video" === t.contentType && (a = t.opts.width && t.opts.height ? c / d : t.opts.ratio || 16 / 9,
            ...
            close: function(t, e) {
                ...
                "auto" == o && (o = Math.abs(h.width / h.height - c.width / c.height) > .1),
                o && (c.opacity = 0),
                i.fancybox.setTranslate(a, l),
                p(a),
                i.fancybox.animate(a, c, s, f),
                0) : (n && s ? i.fancybox.animate(h.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + n, s, f) : !0 === t ? setTimeout(f, s) : f(),
                0))))
            },
            cleanUp: function(e) {
        ...
        i.fancybox = {
            ...
            getInstance: function(t) {
                ...
                return e instanceof v && ("string" === i.type(t) ? e[t].apply(e, n) : "function" === i.type(t) && t.apply(e, n),
                e)
            },
            open: function(t, e, i) {
                return new v(t,e,i)
...
function(t, e, i) {
    ...
    d.prototype.limitMovement = function() {
        var t, e, i, n, s, a, r = this, o = r.canvasWidth, l = r.canvasHeight, c = r.distanceX, d = r.distanceY, u = r.contentStartPos, h = u.left, p = u.top, f = u.width, m = u.height;
        return s = f > o ? h + c : h,
        a = p + d,
        ...
        d < 0 && a < n && (a = n + 1 - Math.pow(n - p - d, .8) || 0),
        {
            top: a,
            left: s
        }
    ...
    d.prototype.onTap = function(e) {
        var n, s = this, r = i(e.target), o = s.instance, l = o.current, c = e && a(e) || s.startPoints, d = c[0] ? c[0].x - i(t).scrollLeft() - s.stagePos.left : 0, u = c[0] ? c[0].y - i(t).scrollTop() - s.stagePos.top : 0, h = function(t) {
            var n = l.opts[t];
...
function(t) {
    ...
    function e() {
        ...
        return n.height || ((e = l.compatMode) || !t.support.boxModel) && (i = "CSS1Compat" === e ? d : l.body,
        n = {
    ...
    t.fn.pagepiling = function(s) {
        ...
        function o(e, i) {
            ...
            if (!n.activeSection.is(e)) {
                ...
                "down" === n.yMovement ? (n.translate3d = R(),
                n.scrolling = "-100%",
                J.css3 || n.sectionsToMove.each(function(e) {
        ...
        function l(e) {
            J.css3 ? (y(e.animateSection, e.translate3d, e.animated),
            e.sectionsToMove.each(function() {
                y(t(this), e.translate3d, e.animated)
            }),
            setTimeout(function() {
                c(e)
            }, J.scrollingSpeed)) : (e.scrollOptions = h(e.scrolling),
            e.animated ? e.animateSection.animate(e.scrollOptions, J.scrollingSpeed, J.easing, function() {
                u(e),
                c(e)
        ...
        function p(t, e) {
            J.anchors.length ? (location.hash = t,
            f(location.hash)) : f(String(e))
        }
        function f(e) {
            e = e.replace("#", ""),
        ...
        function g() {
            ...
            if (s.length && s && s !== j) {
                var a;
                a = isNaN(s) ? t(e).find('[data-anchor="' + s + '"]') : t(".pp-section").eq(s - 1),
                o(a)
            }
        }
        function b(t) {
        ...
        function w(e) {
            ...
            !v()) {
                var c = t(".pp-section.active")
                  , d = C(c);
                return x(U, 10) >= x(U, 70) && o && (a < 0 ? S("down", d) : a > 0 && S("up", d)),
                !1
            }
        }
        function x(t, e) {
            for (var i = 0, n = t.slice(Math.max(t.length - e, 1)), s = 0; s < n.length; s++)
                i += n[s];
        ...
        function E() {
            V.get(0).addEventListener ? (V.get(0).removeEventListener("mousewheel", w, !1),
            V.get(0).removeEventListener("wheel", w, !1)) : V.get(0).detachEvent("onmousewheel", w)
        }
        function _() {
            V.get(0).addEventListener ? (V.get(0).addEventListener("mousewheel", w, !1),
            V.get(0).addEventListener("wheel", w, !1)) : V.get(0).attachEvent("onmousewheel", w)
        }
        function M() {
            if (q) {
                var t = P();
        ...
        function k() {
            if (q) {
                var t = P();
                V.off("touchstart " + t.down),
                V.off("touchmove " + t.move)
            }
        }
        function P() {
        ...
        function z(e) {
            ...
            if (!O(e.target) && L(i)) {
                var n = t(".pp-section.active")
                  , s = C(n);
                if (s.length || e.preventDefault(),
                !v()) {
                    var a = $(i);
                    W = a.y,
                    G = a.x,
                    "horizontal" === J.direction && Math.abs(X - G) > Math.abs(Y - W) ? Math.abs(X - G) > V.width() / 100 * J.touchSensitivity && (X > G ? S("down", s) : G > X && S("up", s)) : Math.abs(Y - W) > V.height() / 100 * J.touchSensitivity && (Y > W ? S("down", s) : W > Y && S("up", s))
                }
            }
        }
        function O(e, i) {
        ...
        function I() {
            ...
            var e = t("#pp-nav");
            e.css("color", J.navigation.textColor),
            e.addClass(J.navigation.position);
            for (var i = 0; i < t(".pp-section").length; i++) {
                var n = "";
                if (J.anchors.length && (n = J.anchors[i]),
                "undefined" !== J.navigation.tooltips) {
        ...
        function D(e, i) {
            J.navigation && (t("#pp-nav").find(".active").removeClass("active"),
            e ? t("#pp-nav").find('a[href="#' + e + '"]').addClass("active") : t("#pp-nav").find("li").eq(i).find("a").addClass("active"))
        }
        function F(e) {
            J.menu && (t(J.menu).find(".active").removeClass("active"),
        ...
        function B() {
            ...
            for (var a in s)
                t.style[a] !== n && (t.style[a] = "translate3d(1px,1px,1px)",
        ...
        var j, H = t.fn.pagepiling, V = t(this), N = 0, q = "ontouchstart"in i || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Y = 0, X = 0, W = 0, G = 0, U = [], Q = 600, J = t.extend(!0, {
            direction: "vertical",
            menu: null,
            verticalCentered: !0,
            sectionsColor: [],
        ...
        H.setAllowScrolling = function(t) {
            t ? (H.setMouseWheelScrolling(!0),
            M()) : (H.setMouseWheelScrolling(!1),
            k())
        }
        ,
        ...
        H.moveSectionUp = function() {
            ...
            !e.length && J.loopTop && (e = t(".pp-section").last()),
            e.length && o(e)
        }
        ,
        H.moveSectionDown = function() {
            var e = t(".pp-section.active").next(".pp-section");
            !e.length && J.loopBottom && (e = t(".pp-section").first()),
            e.length && o(e)
        }
        ,
        H.moveTo = function(i) {
        ...
        t(".pp-section").each(function(e) {
            ...
            J.navigation && (t("#pp-nav").css("margin-top", "-" + t("#pp-nav").height() / 2 + "px"),
            t("#pp-nav").find("li").eq(t(".pp-section.active").index(".pp-section")).find("a").addClass("active")),
...
function(t) {
    ...
    t.extend(t.fn, {
        ...
        rules: function(e, i) {
            var n, s, a, r, o, l, c = this[0], d = void 0 !== this.attr("contenteditable") && "false" !== this.attr("contenteditable");
    ...
    t.extend(t.validator, {
        ...
        methods: {
            ...
            step: function(e, i, n) {
                var s, a = t(i).attr("type"), r = "Step attribute on input type " + a + " is not supported.", o = ["text", "number", "range"], l = new RegExp("\\b" + a + "\\b"), c = a && !l.test(o.join()), d = function(t) {
                    var e = ("" + t).match(/(?:\.(\d+))?$/);
    ...
    var e = function() {
        ...
        function(t, i) {
          ...
          , c = function(e) {
            ...
            this.parents("." + e.activeClass).length || (e.onIdle.call(d(this)),
...
function(t, e) {
            ...
            if (!e.isTouchEvent || "touchmove" === r.type) {
                ...
                !(r.targetTouches && r.targetTouches.length > 1)) {
                    ...
                    if (!(this.params.threshold && Math.sqrt(Math.pow(d, 2) + Math.pow(h, 2)) < this.params.threshold)) {
                        var p;
                        if (void 0 === e.isScrolling && (this.isHorizontal() && s.currentY === s.startY || this.isVertical() && s.currentX === s.startX ? e.isScrolling = !1 : d * d + h * h >= 25 && (p = 180 * Math.atan2(Math.abs(h), Math.abs(d)) / Math.PI,
                        ...
                        e.isScrolling)
                            ...
                            n.resistance && (e.currentTranslate = this.minTranslate() - 1 + Math.pow(-this.minTranslate() + e.startTranslate + f, g))) : f < 0 && e.currentTranslate < this.maxTranslate() && (m = !1,
                            n.resistance && (e.currentTranslate = this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - e.startTranslate - f, g))),
        ...
        !n.cssMode)
            if (n.freeMode) {
                ...
                if (n.freeModeMomentum) {
                    ...
                    if (w < e.maxTranslate())
                        n.freeModeMomentumBounce ? (w + e.maxTranslate() < -C && (w = e.maxTranslate() - C),
                        x = e.maxTranslate(),
                        T = !0,
                        i.allowMomentumBounce = !0) : w = e.maxTranslate(),
                        n.loop && n.centeredSlides && (S = !0);
                    else if (w > e.minTranslate())
                        n.freeModeMomentumBounce ? (w - e.minTranslate() > C && (w = e.minTranslate() + C),
                        x = e.minTranslate(),
                        T = !0,
                    ...
                    0 !== e.velocity) {
                        if (b = a ? Math.abs((-w - e.translate) / e.velocity) : Math.abs((w - e.translate) / e.velocity),
                        n.freeModeSticky) {
                ...
                for (var P = 0, $ = e.slidesSizesGrid[0], L = 0; L < o.length; L += L < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
                    ...
                    void 0 !== o[L + A] ? d >= o[L] && d < o[L + A] && (P = L,
                    $ = o[L + A] - o[L]) : d >= o[L] && (P = L,
                ...
                if (h > n.longSwipesMs) {
                    ...
                    "prev" === e.swipeDirection && (z > 1 - n.longSwipesRatio ? e.slideTo(P + O) : e.slideTo(P))
                } else {
                    if (!n.shortSwipes)
                        return void e.slideTo(e.activeIndex);
        ...
        off: function() {
            ...
            for (var o = n.split(" "), l = 0; l < o.length; l += 1)
                for (var c = o[l], d = 0; d < this.length; d += 1) {
                    var u = this[d]
                      , h = void 0;
                    if (!s && u.dom7Listeners ? h = u.dom7Listeners[c] : s && u.dom7LiveListeners && (h = u.dom7LiveListeners[c]),
                    h && h.length)
                        for (var p = h.length - 1; p >= 0; p -= 1) {
                            var f = h[p];
                            a && f.listener === a || a && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === a ? (u.removeEventListener(c, f.proxyListener, r),
                            h.splice(p, 1)) : a || (u.removeEventListener(c, f.proxyListener, r),
                            h.splice(p, 1))
                        }
                }
            return this
            ...
            for (var i = Object(t[0]), n = 1; n < t.length; n += 1) {
                ...
                if (null != s)
                    for (var a = Object.keys(Object(s)), r = 0, o = a.length; r < o; r += 1) {
                        ...
                        void 0 !== c && c.enumerable && (v.isObject(i[l]) && v.isObject(s[l]) ? v.extend(i[l], s[l]) : !v.isObject(i[l]) && v.isObject(s[l]) ? (i[l] = {},
                        v.extend(i[l], s[l])) : i[l] = s[l])
                    }
            }
            return i
        }
    ...
    var w, x, S, T, C, E, _, M, k, P, $, L, A, z, O, I = {
                ...
                for (var E, _ = e.slidesPerColumn, M = T / _, k = Math.floor(c / e.slidesPerColumn), P = 0; P < c; P += 1) {
                    ...
                    if (e.slidesPerColumn > 1) {
                        ...
                        if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                            ...
                            "column" === e.slidesPerColumnFill ? (z = P - (A = Math.floor(P / _)) * _,
                            (A > k || A === k && z === _ - 1) && (z += 1) >= _ && (z = 0,
                            A += 1)) : A = P - (z = Math.floor(P / M)) * M;
                    ...
                    if ("none" !== $.css("display")) {
                        if ("auto" === e.slidesPerView) {
                            ...
                            e.roundLengths && (C = Math.floor(C)),
                            l[P] && (this.isHorizontal() ? l[P].style.width = C + "px" : l[P].style.height = C + "px");
                        l[P] && (l[P].swiperSlideSize = C),
                        h.push(C),
                        e.centeredSlides ? (w = w + C / 2 + x / 2 + y,
                        0 === x && 0 !== P && (w = w - n / 2 - y),
                        0 === P && (w = w - n / 2 - y),
                        Math.abs(w) < .001 && (w = 0),
                        ...
                        (S - Math.min(this.params.slidesPerGroupSkip, S)) % this.params.slidesPerGroup == 0 && d.push(w),
                        u.push(w),
                        w = w + C + y),
            ...
            if (0 !== n.length) {
                ...
                for (var r = 0; r < n.length; r += 1) {
                    ...
                    if (e.watchSlidesVisibility || e.centeredSlides && e.autoHeight) {
                        ...
                        (c >= 0 && c < this.size - 1 || d > 1 && d <= this.size || c <= 0 && d >= this.size) && (this.visibleSlides.push(o),
        ...
        translateTo: function(t, e, i, n, s) {
            ...
            if (c = n && t > d ? d : n && t < u ? u : t,
            r.updateProgress(c),
            o.cssMode) {
                var h = r.isHorizontal();
                return 0 === e ? l[h ? "scrollLeft" : "scrollTop"] = -c : l.scrollTo ? l.scrollTo(((a = {})[h ? "left" : "top"] = -c,
                a.behavior = "smooth",
                a)) : l[h ? "scrollLeft" : "scrollTop"] = -c,
                !0
            }
        ...
        slideTo: function(t, e, i, n) {
            ...
            if (o.cssMode) {
                var y = a.isHorizontal()
                  , w = -g;
                return h && (w = p.scrollWidth - p.offsetWidth - w),
                0 === e ? p[y ? "scrollLeft" : "scrollTop"] = w : p.scrollTo ? p.scrollTo(((s = {})[y ? "left" : "top"] = w,
                s.behavior = "smooth",
                s)) : p[y ? "scrollLeft" : "scrollTop"] = w,
                !0
            }
    ...
    O = "MacIntel" === w,
    !_ && O && g.touch && (1024 === T && 1366 === C || 834 === T && 1194 === C || 834 === T && 1112 === C || 768 === T && 1024 === C) && (_ = x.match(/(Version)\/([\d.]+)/),
    O = !1),
    S.ie = P,
    S.edge = $,
    S.firefox = L,
    ...
    (_ || k || M) && (S.os = "ios",
    S.ios = !0),
    k && !M && (S.osVersion = k[2].replace(/_/g, "."),
    S.iphone = !0),
    _ && (S.osVersion = _[2].replace(/_/g, "."),
    S.ipad = !0),
    M && (S.osVersion = M[3] ? M[3].replace(/_/g, ".") : null,
    S.ipod = !0),
    ...
    S), N = !1, q = {
        ...
        events: {
            attachEvents: function() {
                ...
                if (!g.touch && g.pointerEvents)
                    ...
                    if (g.touch) {
                        ...
                        i.addEventListener(e.move, this.onTouchMove, g.passiveListener ? {
                            passive: !1,
                            capture: h
                        } : h),
                        i.addEventListener(e.end, this.onTouchEnd, p),
                        e.cancel && i.addEventListener(e.cancel, this.onTouchEnd, p),
                        N || (u.addEventListener("touchstart", d),
                        N = !0)
                    }
                    (t.simulateTouch && !V.ios && !V.android || t.simulateTouch && !g.touch && V.ios) && (i.addEventListener("mousedown", this.onTouchStart, !1),
            ...
            detachEvents: function() {
                ...
                if (!g.touch && g.pointerEvents)
                    ...
                    (t.simulateTouch && !V.ios && !V.android || t.simulateTouch && !g.touch && V.ios) && (i.removeEventListener("mousedown", this.onTouchStart, !1),
            ...
            setBreakpoint: function() {
                ...
                if (a && (!a || 0 !== Object.keys(a).length)) {
                    ...
                    if (r && this.currentBreakpoint !== r) {
                        ...
                        c && !d ? s.removeClass(n.containerModifierClass + "multirow " + n.containerModifierClass + "multirow-column") : !c && d && (s.addClass(n.containerModifierClass + "multirow"),
        ...
        function e() {
            ...
            if (s = d[0]) {
                ...
                return s.swiper = l,
                d.data("swiper", l),
                s && s.shadowRoot && s.shadowRoot.querySelector ? (h = i(s.shadowRoot.querySelector("." + l.params.wrapperClass))).children = function(t) {
                    return d.children(t)
                }
        ...
        update: function(t) {
            ...
            r ? (y = Math.floor(s / 2) + a + l,
            w = Math.floor(s / 2) + a + c) : (y = s + (a - 1) + l,
            w = a + c);
            ...
            u === S && h === T && !t)
                return i.slidesGrid !== f && C !== g && i.slides.css(b, C + "px"),
            ...
            if (t)
                ...
                for (var M = u; M <= h; M += 1)
                    (M < S || M > T) && i.$wrapperEl.find("." + i.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
            for (var k = 0; k < p.length; k += 1)
                k >= S && k <= T && (void 0 === h || t ? _.push(k) : (k > h && _.push(k),
                k < u && E.push(k)));
            ...
            n.params.freeMode) {
                ...
                if (!u) {
                    ...
                    var h = n.getTranslate() + r * s.sensitivity
                      , p = n.isBeginning
                      , f = n.isEnd;
                    if (h >= n.minTranslate() && (h = n.minTranslate()),
        ...
        animateSlider: function(t) {
            return t.delta >= 6 && v.now() - this.mousewheel.lastScrollTime < 60 || (t.direction < 0 ? this.isEnd && !this.params.loop || this.animating || (this.slideNext(),
        ...
        enableDraggable: function() {
            if (this.params.scrollbar.el) {
                ...
                g.touch ? (s.addEventListener(e.start, this.scrollbar.onDragStart, a),
        ...
        disableDraggable: function() {
            if (this.params.scrollbar.el) {
                ...
                g.touch ? (s.removeEventListener(e.start, this.scrollbar.onDragStart, a),
        ...
        onGestureChange: function(t) {
            ...
            n.$imageEl && 0 !== n.$imageEl.length && (i.scale = g.gestures ? t.scale * i.currentScale : n.scaleMove / n.scaleStart * i.currentScale,
        ...
        onGestureEnd: function(t) {
            ...
            if (!g.gestures) {
                if (!i.fakeGestureTouched || !i.fakeGestureMoved)
                    return;
                if ("touchend" !== t.type || "touchend" === t.type && t.changedTouches.length < 2 && !V.android)
                    return;
        ...
        onTouchStart: function(t) {
            var e = this.zoom
              , i = e.gesture
              , n = e.image;
            i.$imageEl && 0 !== i.$imageEl.length && (n.isTouched || (V.android && t.cancelable && t.preventDefault(),
            n.isTouched = !0,
        ...
        in: function(t) {
            var e, i, n, s, a, r, o, l, c, d, u, h, p, f, m, v, g = this.zoom, b = this.params.zoom, y = g.gesture, w = g.image;
        ...
        enable: function() {
            ...
            if (!t.enabled) {
                ...
                g.gestures ? (this.$wrapperEl.on("gesturestart", n, t.onGestureStart, e),
        ...
        disable: function() {
            ...
            if (t.enabled) {
                ...
                var e = !("touchstart" !== this.touchEvents.start || !g.passiveListener || !this.params.passiveListeners) && {
                  ...
                  , n = "." + this.params.slideClass;
                g.gestures ? (this.$wrapperEl.off("gesturestart", n, t.onGestureStart, e),
        ...
        load: function() {
            ...
            if (c.loadPrevNext)
                if (d > 1 || c.loadPrevNextAmount && c.loadPrevNextAmount > 1) {
                    for (var h = c.loadPrevNextAmount, p = d, f = Math.min(o + p + Math.max(h, p), r.length), m = Math.max(o - Math.max(p, h), 0), v = o + d; v < f; v += 1)
        ...
        setTranslate: function(t, e) {
            ...
            if (Array.isArray(r))
                for (var o = 0; o < r.length; o += 1)
                    r[o] !== e && r[o]instanceof W && i(r[o]);
            else
                r instanceof W && e !== r && i(r)
        },
        setTransition: function(t, e) {
            function i(e) {
                e.setTransition(t, s),
            ...
            if (Array.isArray(a))
                for (n = 0; n < a.length; n += 1)
                    a[n] !== e && a[n]instanceof W && i(a[n]);
            else
                a instanceof W && e !== a && i(a)
        }
    }, pt = {
        ...
        setTranslate: function() {
            var t, e = this.$el, n = this.$wrapperEl, s = this.slides, a = this.width, r = this.height, o = this.rtlTranslate, l = this.size, c = this.params.cubeEffect, d = this.isHorizontal(), u = this.virtual && this.params.virtual.enabled, h = 0;
            c.shadow && (d ? (0 === (t = n.find(".swiper-cube-shadow")).length && (t = i('<div class="swiper-cube-shadow"></div>'),
            n.append(t)),
            t.css({
                height: a + "px"
            ...
            for (var p = 0; p < s.length; p += 1) {
                ...
                c.slideShadows) {
                    ...
                    0 === T.length && (T = i('<div class="swiper-slide-shadow-' + (d ? "left" : "top") + '"></div>'),
                    f.append(T)),
                    0 === C.length && (C = i('<div class="swiper-slide-shadow-' + (d ? "right" : "bottom") + '"></div>'),
                    f.append(C)),
        ...
        setTranslate: function() {
            for (var t = this.slides, e = this.rtlTranslate, n = 0; n < t.length; n += 1) {
                ...
                this.params.flipEffect.slideShadows) {
                    ...
                    0 === d.length && (d = i('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'),
                    s.append(d)),
        ...
        update: function(t) {
            ...
            if (e) {
                ...
                e.params.loop || e.params.virtual && e.params.virtual.enabled)
                    for (var h = 0; h < d; h += 1)
                        e.$wrapperEl.children('[data-swiper-slide-index="' + (this.realIndex + h) + '"]').addClass(u);
                else
                    for (var p = 0; p < d; p += 1)
